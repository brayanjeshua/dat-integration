 ...
 * search criteria, including several ways of specifying origin and destination
 * locations.
 * 
 * The shipmentSearchXYZ and equipmentSearchXYZ methods intentionally contain a
 * lot of duplicated boilerplate code. Most consumers will only need to look at
 * 1 or 2 methods to find the examples required for a specific use case.
 * 
 * To ensure that the searches will return matches, the application first posts
 * several assets. For more detailed examples of posting operations, see
 * {@link PostAssets}.
 * 
