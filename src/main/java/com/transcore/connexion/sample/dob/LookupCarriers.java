...
public class LookupCarriers extends BaseSampleClient {
    ...
    protected void lookupDOTCarrier(final SessionToken sessionToken, final String carrierId,
        ...
        System.out.println("LookupDOTCarrier - endpointUrl: " + endpointUrl);
        ...
        final TfmiFreightMatchingServiceStub stub = new TfmiFreightMatchingServiceStub(
                (subEndPointUrl == null) ? endpointUrl : subEndPointUrl);
            ...
            if (successData.getDobCarrier() != null) {
                if (successData.getDobCarrier().getCarrierInfo() != null) {
                    ...
                    if (successData.getDobCarrier().getCarrierInfo().getScacCodeArray() != null) {
                        for (int i = 0; i < successData.getDobCarrier().getCarrierInfo().getScacCodeArray().length; ++i) {
                            System.out.println("Scacc Code:"
                                    + successData.getDobCarrier().getCarrierInfo().getScacCodeArray()[i]);
                        }
                    }
                ...
                if (successData.getDobCarrier().getContactInfo().getContactsArray() != null) {
                    for (int i = 0; i < successData.getDobCarrier().getContactInfo().getContactsArray().length; ++i) {
                        System.out.println("Contact...");

                        final Contact c = successData.getDobCarrier().getContactInfo().getContactsArray()[i];
                        if (c.getEmail() != null) {
                ...
                if (successData.getDobCarrier().getDocumentsArray() != null) {
                    for (int i = 0; i < successData.getDobCarrier().getDocumentsArray().length; ++i) {
                        final Document d = successData.getDobCarrier().getDocumentsArray()[i];
                ...
                if (successData.getDobCarrier().getEquipment() != null) {
                    ...
                    if (successData.getDobCarrier().getEquipment().getTrailersArray() != null) {
                        for (int i = 0; i < successData.getDobCarrier().getEquipment().getTrailersArray().length; ++i) {
                            final Trailer t = successData.getDobCarrier().getEquipment().getTrailersArray()[i];
                ...
                if (successData.getDobCarrier().getGeographicCoverage() != null) {
                    if (successData.getDobCarrier().getGeographicCoverage().getLanesArray() != null) {
                        for (int i = 0; i < successData.getDobCarrier().getGeographicCoverage()
                                .getLanesArray().length; ++i) {
                            System.out.println("Lane Type...");
                            final LaneType lt = successData.getDobCarrier().getGeographicCoverage()
                                    .getLanesArray()[i];
                    ...
                    if (successData.getDobCarrier().getGeographicCoverage().getOperatingStateProvinceArray() != null) {
                        for (int i = 0; i < successData.getDobCarrier().getGeographicCoverage()
                                .getOperatingStateProvinceArray().length; ++i) {
                            System.out.println("Geographic Coverage operation state province:"
                                    + successData.getDobCarrier().getGeographicCoverage()
                                            .getOperatingStateProvinceArray()[i].toString());
                        }
                    }
